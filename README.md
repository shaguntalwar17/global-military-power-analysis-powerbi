...
- Energy resources (oil, coal, natural gas production)  
- Infrastructure indicators (airports, roadways, railways)  
- Geographic coverage such as coastline and land area  
...
Understanding military power through data helps move discussions away from assumptions and toward **measurable indicators**.  
This project demonstrates how **data analytics and visualization** can simplify complex global datasets and support informed analysis of strategic capability and resource distribution.

---

## Author
**Shagun Talwar**  
Power BI | Data Analytics | Comparative & Social Impact Projects
